Public Class BrowseLettersAF
    ...
    Public Sub New(ByVal caller As Object)
        ...
        Header.Text = "Browse Genre by " & myState.browseType & ": G-K"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        myState.filteredCatalog = myState.myCatalog.BrowseByLetter(myState.browseType, "A")
        Dim frm As New BrowseResults(Me)
        frm.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        myState.filteredCatalog = myState.myCatalog.BrowseByLetter(myState.browseType, "B")
        Dim frm As New BrowseResults(Me)
        frm.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        myState.filteredCatalog = myState.myCatalog.BrowseByLetter(myState.browseType, "C")
        Dim frm As New BrowseResults(Me)
        frm.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub Button8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button8.Click
        myState.filteredCatalog = myState.myCatalog.BrowseByLetter(myState.browseType, "D")
        Dim frm As New BrowseResults(Me)
        frm.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        myState.filteredCatalog = myState.myCatalog.BrowseByLetter(myState.browseType, "E")
        Dim frm As New BrowseResults(Me)
        frm.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        myState.filteredCatalog = myState.myCatalog.BrowseByLetter(myState.browseType, "F")
        Dim frm As New BrowseResults(Me)
        frm.Show()
        Me.Hide()
    End Sub
