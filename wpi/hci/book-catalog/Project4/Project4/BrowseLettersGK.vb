Public Class BrowseLettersGK
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        myState.filteredCatalog = myState.myCatalog.BrowseByLetter(myState.browseType, "G")
        Dim frm As New BrowseResults(Me)
        frm.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        myState.filteredCatalog = myState.myCatalog.BrowseByLetter(myState.browseType, "H")
        Dim frm As New BrowseResults(Me)
        frm.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        myState.filteredCatalog = myState.myCatalog.BrowseByLetter(myState.browseType, "I")
        Dim frm As New BrowseResults(Me)
        frm.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        myState.filteredCatalog = myState.myCatalog.BrowseByLetter(myState.browseType, "J")
        Dim frm As New BrowseResults(Me)
        frm.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        myState.filteredCatalog = myState.myCatalog.BrowseByLetter(myState.browseType, "K")
        Dim frm As New BrowseResults(Me)
        frm.Show()
        Me.Hide()
    End Sub
