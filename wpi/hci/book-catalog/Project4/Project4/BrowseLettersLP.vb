Public Class BrowseLettersLP
    ...
    Public Sub New(ByVal caller As Object)
        ...
        Header.Text = "Browse Genre by " & myState.browseType & ": L-P"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        myState.filteredCatalog = myState.myCatalog.BrowseByLetter(myState.browseType, "L")
        Dim frm As New BrowseResults(Me)
        frm.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        myState.filteredCatalog = myState.myCatalog.BrowseByLetter(myState.browseType, "M")
        Dim frm As New BrowseResults(Me)
        frm.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        myState.filteredCatalog = myState.myCatalog.BrowseByLetter(myState.browseType, "N")
        Dim frm As New BrowseResults(Me)
        frm.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        myState.filteredCatalog = myState.myCatalog.BrowseByLetter(myState.browseType, "O")
        Dim frm As New BrowseResults(Me)
        frm.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        myState.filteredCatalog = myState.myCatalog.BrowseByLetter(myState.browseType, "P")
        Dim frm As New BrowseResults(Me)
        frm.Show()
        Me.Hide()
    End Sub
