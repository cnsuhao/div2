Public Class BrowseLettersQU
    ...
    Public Sub New(ByVal caller As Object)
        ...
        Header.Text = "Browse Genre by " & myState.browseType & ": Q-U"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        myState.filteredCatalog = myState.myCatalog.BrowseByLetter(myState.browseType, "Q")
        Dim frm As New BrowseResults(Me)
        frm.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        myState.filteredCatalog = myState.myCatalog.BrowseByLetter(myState.browseType, "R")
        Dim frm As New BrowseResults(Me)
        frm.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        myState.filteredCatalog = myState.myCatalog.BrowseByLetter(myState.browseType, "S")
        Dim frm As New BrowseResults(Me)
        frm.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        myState.filteredCatalog = myState.myCatalog.BrowseByLetter(myState.browseType, "T")
        Dim frm As New BrowseResults(Me)
        frm.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        myState.filteredCatalog = myState.myCatalog.BrowseByLetter(myState.browseType, "U")
        Dim frm As New BrowseResults(Me)
        frm.Show()
        Me.Hide()
    End Sub
