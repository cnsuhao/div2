Public Class SearchResults
    ...
    Public Sub New(ByVal caller As Object)
        ...
        Results.Text = "Search Results: " & myState.filteredCatalog.Items.Count

        cbox.Items.Add("Author")
        cbox.Items.Add("Title")
        cbox.Items.Add("Genre")
        ...
        If myState.searchedBy = "Title" Then
            index = 0
        ElseIf myState.searchedBy = "Author" Then
            index = 1
        ElseIf myState.searchedBy = "Genre" Then
            index = 2
        End If

        DataGridView1.Sort(DataGridView1.Columns(index), ComponentModel.ListSortDirection.Ascending)

        cbox.SelectedIndex = cbox.Items.IndexOf(myState.searchedBy)
        TextBox1.Text = myState.searched
    End Sub
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbox.SelectedIndexChanged

    End Sub

    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        myState.searchedBy = cbox.SelectedItem
        myState.searched = TextBox1.Text
        myState.filteredCatalog = myState.myCatalog.SearchCatalog(TextBox1.Text.ToLower, cbox.SelectedItem.ToString)
